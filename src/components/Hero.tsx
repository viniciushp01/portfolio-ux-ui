  ...
  return (
    <section className="flex flex-col justify-center min-h-screen px-4 md:px-8 lg:px-20 max-w-[1600px] mx-auto pt-[120px] md:pt-[152px] lg:pt-[160px] pb-12 lg:pb-0">
      <div className="mt-12 lg:mt-10 max-w-4xl">
        <h1 className="text-[clamp(48px,8vw,92px)] font-semibold leading-[0.95] tracking-[-3px] mb-4">
          Hi, I'm Vinicius.<br />
          <span className="text-[#a1a1a1]">Product Designer</span>
        </h1>

        <RotatingTagline className="text-lg sm:text-xl md:text-2xl tracking-[0.5px] mb-12" />
        ...
        <div className="max-w-[550px] text-lg leading-[1.6] text-[#a1a1a1] space-y-5">
          <p>I help SaaS products grow acquisition and retention through research-driven design.</p>
          <p>With a background in psychology and experience in wellness and fitness, I turn business logic into interfaces users don't have to think about.</p>
        </div>
      </div>
    </section>
  );
